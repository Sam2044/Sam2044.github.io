...
<div class="wrapper" id="wrapper">
  <header>
    ...
    <div class="banner row" id="banner">
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 noPadd" style="height:100%">
        ...
        <div class="bannerPart"> <img src="images/portfolio/big/background1.jpg" alt="" class="bannerImg"> </div>
        <!--background slide show end-->
      </div>
    </div>
    <!--banner end-->
    <div class="bannerText container">
      <h1>I'm Samuel Mzee</h1>
      <h2>Design & Build Beautiful Crafted Web and Desktop Experiences</h2>
    </div>
    <!--menu start-->
    <div class="menu">
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        style="text-align: center; margin:auto; width:50%">
          <h3>Samuel Mzee</h3>
          <h4 class="subHeading">Desktop & Web Developer from Wichita</h4>
          <p>Dedicated web,desktop and mobile app developer specializing in the .NET stack with 5 years of collective programming experience spanning from C to Python. </p>
          <p>Strong creative and analytical skills with proven application development experience. Team player with an eye for detail. </p>
      ...
      <div class="row">
        <div class=" col-xs-12 col-sm-4 col-md-4 col-lg-4 skillsArea">
          <div class=" col-xs-12 col-sm-6 col-md-6 col-lg-6 skills"> <span class="chart skilBg" data-percent="90"> <span class="percent"></span> </span>
            <h4>ASP.NET</h4>
            <p>MVC pattern,Webforms,Syncfusion controls</p>
          </div>
        </div>
        <div class=" col-xs-12 col-sm-4 col-md-4 col-lg-4 skillsArea">
          <div class=" col-xs-12 col-sm-6 col-md-6 col-lg-6 skills"> <span class="chart skilBg" data-percent="80"> <span class="percent"></span> </span>
            <h4>Xamarin</h4>
            <p>Cross platform mobile application development in C#</p>
          </div>
        </div>
        <div class=" col-xs-12 col-sm-4 col-md-4 col-lg-4 skillsArea">
          <div class=" col-xs-12 col-sm-6 col-md-6 col-lg-6 skills"> <span class="chart skilBg" data-percent="80"> <span class="percent"></span> </span>
            <h4>Windows Presentation Foundation(WPF)</h4>
            <p>Desktop application development in C#</p>
          </div>
        </div>
        <div class=" col-xs-12 col-sm-4 col-md-4 col-lg-4 skillsArea">
          <div class=" col-xs-12 col-sm-6 col-md-6 col-lg-6 skills"> <span class="chart skilBg" data-percent="80"> <span class="percent"></span> </span>
            <h4>Flask</h4>
            <p>Python's micro web framework</p>
          </div>
        </div>
        <div class=" col-xs-12 col-sm-4 col-md-4 col-lg-4 skillsArea">
          <div class=" col-xs-12 col-sm-6 col-md-6 col-lg-6 skills"> <span class="chart skilBg" data-percent="75"> <span class="percent"></span> </span>
            ...
            <p>Front end development for the web</p>
          </div>
        </div>
        <div class=" col-xs-12 col-sm-4 col-md-4 col-lg-4 skillsArea">
          <div class=" col-xs-12 col-sm-6 col-md-6 col-lg-6 skills"> <span class="chart skilBg" data-percent="60"> <span class="percent"></span> </span>
            <h4>jQuery</h4>
            <p>Always useful in making websites more interactive</p>
          </div>
        </div>
        <div class=" col-xs-12 col-sm-4 col-md-4 col-lg-4 skillsArea">
          <div class=" col-xs-12 col-sm-6 col-md-6 col-lg-6 skills"> <span class="chart skilBg" data-percent="80"> <span class="percent"></span> </span>
            <h4> SQL</h4>
            <p> The main query langauge for persisting data in applications</p>
          </div>
        </div>
        <!-- <div class=" col-xs-12 col-sm-4 col-md-4 col-lg-4 skillsArea">
          <div class=" col-xs-12 col-sm-6 col-md-6 col-lg-6 skills"> <span class="chart skilBg" data-percent="80"> <span class="percent"></span> </span>
            <h4>Lunacy</h4>
            <p>Design and prototyping tool that's basically Sketch for windows</p>
          </div>
        </div> -->
      </div>
    </div>
    ...
    <div class="container">
      ...
      <div class="row workDetails">
        <div class="col-xs-12 col-sm-3 col-md-2 col-lg-2">
          <div class="workYear">Sep,2019<br>
            June,2020</div>
        </div>
        <div class="col-xs-12 col-sm-9 col-md-10 col-lg-10 rightArea">
          <div class="arrowpart"></div>
          <div class="exCon">
            <h4>Visual Perception and Coordination Lab,Wichita State University</h4>
            <h5>Junior Developer Internship</h5>
            <p>Shortened time to develop psychology experiments for android by 3 months.Built experiments for android using Python's Kivy and made use of machine learning techniques to analyze data</p>
          </div>
        </div>
      </div>
      <div class="row workDetails">
        <div class="col-xs-12 col-sm-3 col-md-2 col-lg-2">
          <div class="workYear">Sep,2020<br>
            Jan,2021</div>
        </div>
        <div class="col-xs-12 col-sm-9 col-md-10 col-lg-10 rightArea">
          <div class="arrowpart"></div>
          <div class="exCon">
            <h4>National Institute of Aviation Research</h4>
            <h5>Research Software Engineer internship</h5>
            <p>Developed an object identification and classification model in python for analyzing carbon fibre composites. Built a dashboard in ASP.NET Webforms in 2 weeks to visualize analysis data.</p>
          </div>
        </div>
      </div>
      <!-- <div class="row workDetails">
  ...
  <section class="education" id="education">
    <div class="container">
      ...
      <div class="row workDetails">
        <div class="col-xs-12 col-sm-3 col-md-2 col-lg-2">
          <div class="workYear">Dec,2020</div>
        </div>
        <div class="col-xs-12 col-sm-9 col-md-10 col-lg-10 rightArea">
          <div class="arrowpart"></div>
          <div class="exCon">
            <h4>Bachelor of Science,Computer Science</h4>
            <h5>Wichita State University</h5>
      ...
      <div class="row workDetails">
        <div class="col-xs-12 col-sm-3 col-md-2 col-lg-2">
          <div class="workYear">Aug, 2018</div>
        </div>
        <div class="col-xs-12 col-sm-9 col-md-10 col-lg-10 rightArea">
          <div class="arrowpart"></div>
          <div class="exCon">
            <h4>Bachelor of Science,Computer Science</h4>
            <h5>Multimedia University of Kenya</h5>
...
<p> <i class="fa fa-map-marker fa-lg"></i> 67220,Wichita Kansas,United States</p>
        <p> <i class="fa fa-mobile fa-lg"></i> +1(316)670-3379</p>
        <p> <i class="fa fa-envelope-o "></i> <a href="mailto:support@websitename.com">support@samuelmzee.com</a></p>
        <p> <i class="fa fa-link "></i> <a href="www.samuelmzee.com">www.samuelmzee.com</a></p>
      </div>
      <!--contact info end-->
      <!--contact form start-->
  ...
  <section class="footer" id="footer">
    <div class="container">
      <ul>
        ...
        <li><a href="https://www.linkedin.com/in/samuel-mzee-43204411a/"><i class="fa fa-linkedin fa-2x"></i></a></li>
